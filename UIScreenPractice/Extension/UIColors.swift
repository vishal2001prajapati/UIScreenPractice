...
extension UIColor {
    static let placeholderColor: UIColor = UIColor(named: "PlaceholderColor") ?? UIColor.white
    static let placeholderTextColor: UIColor = UIColor(named: "placeholderTextColor") ?? UIColor.white
